...
public class Flink02_SQL_Demo {
    public static void main(String[] args) throws Exception {
        ...
        //0x3 查询数据 todo Fink sql
        Table resultOfSQL = tableEnv.sqlQuery("select id,temp from sensor where id = 'sensor_1'");

        //0x4 转换为流输出
        tableEnv.toAppendStream(resultOfSQL, Row.class).print();
