...
public class Flink02_Window_Watermark_ASC1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //引入事件时间语义,指定设定 ProcessingTime EventTime IngestionTime
        ...
        //指定数据中的时间字段
        SingleOutputStreamOperator<String> stringSingleOutputStreamOperator = socketTextStream
                .assignTimestampsAndWatermarks(new BoundedOutOfOrdernessTimestampExtractor<String>(Time.seconds(2)) {
                    ...
                    public long extractTimestamp(String element) {
                        ...
                        return Long.parseLong(ts[1])*1000L;
                    }
                });
