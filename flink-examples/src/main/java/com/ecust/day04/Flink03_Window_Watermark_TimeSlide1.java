...
public class Flink03_Window_Watermark_TimeSlide1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //5.开窗
        WindowedStream<Tuple2<String, Integer>, Tuple, TimeWindow> windowedStream = keyedStream.timeWindow(Time.seconds(6), Time.seconds(2));

        windowedStream.apply(new MyWindowFunc1());
    ...
    private static class MyWindowFunc1 implements WindowFunction<Tuple2<String, Integer>,Integer,Tuple,TimeWindow> {
        @Override
